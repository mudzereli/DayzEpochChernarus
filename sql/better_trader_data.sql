/* add air vehicles */
INSERT INTO `Traders_DATA` (`item`, `qty`, `buy`, `sell`, `order`, `tid`, `afile`) select '["GNT_C185F",1]'        as item, 9999 as qty, buy, sell, `order`, tid, afile from `Traders_DATA` where item = '["GNT_C185",1]';
INSERT INTO `Traders_DATA` (`item`, `qty`, `buy`, `sell`, `order`, `tid`, `afile`) select '["GNT_C185E",1]'        as item, 9999 as qty, buy, sell, `order`, tid, afile from `Traders_DATA` where item = '["GNT_C185",1]';
INSERT INTO `Traders_DATA` (`item`, `qty`, `buy`, `sell`, `order`, `tid`, `afile`) select '["MH6J_EP1",1]'         as item, 9999 as qty, buy, sell, `order`, tid, afile from `Traders_DATA` where item = '["AH6X_DZ",1]';
INSERT INTO `Traders_DATA` (`item`, `qty`, `buy`, `sell`, `order`, `tid`, `afile`) select '["An2_1_TK_CIV_EP1",1]' as item, 9999 as qty, buy, sell, `order`, tid, afile from `Traders_DATA` where item = '["AN2_DZ",1]';
INSERT INTO `Traders_DATA` (`item`, `qty`, `buy`, `sell`, `order`, `tid`, `afile`) select '["An2_2_TK_CIV_EP1",1]' as item, 9999 as qty, buy, sell, `order`, tid, afile from `Traders_DATA` where item = '["AN2_DZ",1]';
INSERT INTO `Traders_DATA` (`item`, `qty`, `buy`, `sell`, `order`, `tid`, `afile`) select '["An2_TK_EP1",1]'       as item, 9999 as qty, buy, sell, `order`, tid, afile from `Traders_DATA` where item = '["AN2_DZ",1]';
INSERT INTO `Traders_DATA` (`item`, `qty`, `buy`, `sell`, `order`, `tid`, `afile`) select '["Ka137_PMC",1]'        as item, 9999 as qty, buy, sell, `order`, tid, afile from `Traders_DATA` where item = '["CSJ_GyroC",1]';
/* add normal land vehicles */
INSERT INTO `Traders_DATA` (`item`, `qty`, `buy`, `sell`, `order`, `tid`, `afile`) select '["policecar",1]'          as item, 9999 as qty, buy, sell, `order`, tid, afile from `Traders_DATA` where item = '["Skoda",1]';
INSERT INTO `Traders_DATA` (`item`, `qty`, `buy`, `sell`, `order`, `tid`, `afile`) select '["TowingTractor",1]'      as item, 9999 as qty, buy, sell, `order`, tid, afile from `Traders_DATA` where item = '["MMT_Civ",1]';
INSERT INTO `Traders_DATA` (`item`, `qty`, `buy`, `sell`, `order`, `tid`, `afile`) select '["HMMWV_Terminal_EP1",1]' as item, 9999 as qty, buy, sell, `order`, tid, afile from `Traders_DATA` where item = '["HMMWV_Ambulance",1]';
/* military vehicles */ 
