...
[[(_coords select 0) - 20, (_coords select 1) - 15,0],4,0,DZMSUnitArrayMinor] call DZMSAISpawn;
sleep 3;
[[(_coords select 0) + 10, (_coords select 1) + 15,0],4,0,DZMSUnitArrayMinor] call DZMSAISpawn;
sleep 3;
[[(_coords select 0) - 10, (_coords select 1) - 15,0],4,0,DZMSUnitArrayMinor] call DZMSAISpawn;
sleep 3;
[[(_coords select 0) + 20, (_coords select 1) + 15,0],4,0,DZMSUnitArrayMinor] call DZMSAISpawn;
