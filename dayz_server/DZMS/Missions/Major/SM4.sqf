...
[[(_coords select 0) - 8.4614,(_coords select 1) - 5.0527,0],6,1,DZMSUnitArrayMajor] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) - 8.4614,(_coords select 1) - 5.0527,0],4,1,DZMSUnitArrayMajor] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) + 7.5337,(_coords select 1) + 4.2656,0],4,1,DZMSUnitArrayMajor] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) + 7.5337,(_coords select 1) + 4.2656,0],4,1,DZMSUnitArrayMajor] call DZMSAISpawn;
sleep 5;
