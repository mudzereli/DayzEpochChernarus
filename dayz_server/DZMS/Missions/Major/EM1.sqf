...
[[(_coords select 0) - 10.5005,(_coords select 1) - 2.6465,0],6,1,DZMSUnitArrayMajor] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) + 4.7027,(_coords select 1) + 12.2138,0],6,1,DZMSUnitArrayMajor] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) + 2.918,(_coords select 1) - 9.0342,0],4,1,DZMSUnitArrayMajor] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) + 2.918,(_coords select 1) - 9.0342,0],4,1,DZMSUnitArrayMajor] call DZMSAISpawn;
...
diag_log format["[DZMS]: Major EM1 C130 Mission has Ended."];
