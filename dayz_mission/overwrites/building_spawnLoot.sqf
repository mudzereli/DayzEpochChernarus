...
//### BEGIN INSERTED CODE: LOOTCHANCE MULTIPLIER
_lootChance = _lootChance * DZ_LOOTCHANCE_MULTIPLIER;
//### END INSERTED CODE: LOOTCHANCE MULTIPLIER

if (_lootChance > 1) then {_lootChance = 1;};
